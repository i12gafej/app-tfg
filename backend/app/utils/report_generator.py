...
class ReportGenerator:
    ...
    def generate_report(self, data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            internal_consistency_text += self.generate_photo({"photo_url": data["internal_consistency_graph"], "description": "Gráfico de coherencia interna"}, background_color="#FFFFFF")
    ...
    def generate_report_preview(self, data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            print("INTERNAL CONSISTENCY LEGEND:", internal_consistency_legend)
