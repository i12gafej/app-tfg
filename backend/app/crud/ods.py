...
def get_secondary_impacts(db: Session, material_topic_id: int) -> List[int]:
    """
    Obtiene los ODS de impacto secundario para un asunto de materialidad.
    """
    try:
...
def get_all_secondary_impacts_by_report(db: Session, report_id: int) -> List[dict]:
    """
    Obtiene los ODS de impacto secundario para una memoria.
    """
    try:
...
def update_secondary_impacts(
    ...
    """
    Actualiza los ODS de impacto secundario para un asunto de materialidad.
    """
    try:
