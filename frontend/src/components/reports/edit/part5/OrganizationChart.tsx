...
const OrganizationChart = () => {
  ...
  const editor = useEditor({
    ...
    content: report?.org_chart_text || '<p>Escribe aquí la descripción del organigrama de la organización...</p>',
  });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccessMessage('Organigrama guardado correctamente');
    } catch (err) {
      console.error('Error al guardar el organigrama:', err);
